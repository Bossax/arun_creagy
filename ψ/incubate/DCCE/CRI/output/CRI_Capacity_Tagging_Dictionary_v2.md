...
- Map selected NotebookLM concepts into v2 `indicator_concept` entries.
...
- `indicator_concept` – Short, human-readable label used locally in v2 to name the indicator concept.
...
| indicator_concept                      | baseline_proxy                                                                                                       | target_process_metric                                                         | capacity_category | aspect_or_dimension | governance_function         | data_richness_confidence_0_3 | supporting_evidence                                |
| -------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ----------------- | ------------------- | --------------------------- | ---------------------------- | -------------------------------------------------- |
