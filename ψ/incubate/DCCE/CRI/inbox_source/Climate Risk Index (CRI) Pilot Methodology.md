...
>[!attention]
>**Clarification (TEI–Creagy meeting 4 Feb 2026):** ชุดข้อมูล Pilot ที่ใช้งานจริง **ไม่มีข้อมูลมูลค่าความเสียหายเป็นตัวเงินจาก ปภ.** (มีเฉพาะผู้เสียชีวิตและผู้ได้รับผลกระทบ). ส่วนตัวเลขเชิงเศรษฐกิจใช้ **เงินเยียวยาเกษตรกรจาก สศก.** เป็น Proxy หลัก และใช้ **GPP รวมทั้งจังหวัด** เป็นตัวหาร (ยังไม่แยกภาค). ค่าศูนย์ (0) ในหลายจังหวัดจึงสะท้อน **ไม่มีรายงานเข้า** มากกว่าการไม่มีความเสียหายจริง โดยเฉพาะในกรุงเทพฯ และจังหวัดที่มีสัดส่วนภาคเกษตรต่ำ. [[2026-02-04 Creagy and TEI Discussion on CRI]]
