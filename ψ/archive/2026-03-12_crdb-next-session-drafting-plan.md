# Next Session Plan — CRDB interim report drafting

## Reference handoff
- Handoff file: [`ψ/inbox/handoff/2026-03-12_17-47_crdb-interim-report-drafting-handoff.md`](ψ/inbox/handoff/2026-03-12_17-47_crdb-interim-report-drafting-handoff.md)
...
- Continue drafting the interim report beyond Chapter 1 Section 1.
- Tighten tone and redundancy inside the drafted Section 1 subsections.
- Draft Section 2 using the same evidence-to-claim discipline.
...
4. Review the drafted Section 1 in [`ψ/incubate/DCCE/CRDB/inbox_note/CRDB interim report.md`](ψ/incubate/DCCE/CRDB/inbox_note/CRDB%20interim%20report.md), then continue with Chapter 2.
5. Draft the FGD2 validated/changed insert after the Chapter 2 structure is stable.

## Next Session: Pick Your Path

| Option | Command | What It Does |
|--------|---------|--------------|
| **Continue** | [`/recap`](.roo) | Pick up the CRDB interim-report drafting flow from the current baseline |
| **Clean up first** | Review cleanup list below, then [`/recap`](.roo) | Reconcile file moves and uncommitted writing artifacts before drafting |
| **Fresh start** | [`/recap --quick`](.roo) | Reload only the essential CRDB context and decide whether to continue drafting or re-scope |

### Cleanup Checklist
- [ ] Reconcile uncommitted CRDB writing changes and file relocations visible in git status
- [ ] Reconfirm the latest evidence filenames in [`ψ/incubate/DCCE/CRDB/inbox_source/`](ψ/incubate/DCCE/CRDB/inbox_source/) and [`ψ/incubate/DCCE/CRDB/output/`](ψ/incubate/DCCE/CRDB/output/)
- [ ] Review drafted Section 1 for tone consistency before expanding the report
