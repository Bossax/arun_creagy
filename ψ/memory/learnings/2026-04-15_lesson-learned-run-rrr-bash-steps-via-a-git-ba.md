---
title: # Lesson Learned: Run /rrr bash steps via a Git Bash wrapper (Windows tool-runne
tags: [rrr, recap, gitbash, windows, cli]
created: 2026-04-15
source: C:\Users\sitth\OracleWorkspace\Arun_Creagy\ψ\memory\learnings\2026-02-18_rrr-exec-via-gitbash-wrapper.md
---

# # Lesson Learned: Run /rrr bash steps via a Git Bash wrapper (Windows tool-runne
